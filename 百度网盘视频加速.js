...
return ;
    ...
    obj.initPlayerEvents = function (player) {
        ...
        player.on("ended", function () {
            obj.isAppreciation(function (data) {
                data ? localStorage.getItem("dplayer-autoplaynext") == "1" && obj.getJquery()(".next-icon").click() : (obj.msg("\u7231\u53d1\u7535\u0020\u81ea\u52a8\u8df3\u8f6c\u4e0b\u4e00\u96c6"), contextmenu.show(offsetWidth / 25, offsetHeight / 30));
            });
        });
    ...
    obj.dPlayerSetting = function (player) {
        ...
        user.init();
        obj.isAppreciation(function (data) {
            data || (user.set("autoposition", 0), user.set("autoplaynext", 0), user.set("soundenhancement", 0), user.set("imageenhancement", 0));
        });
